...
use crate::pollux::actors::{EvaluationOutcome, EvaluationResults, StatisticsForPackages};
use ractor::{Actor, ActorProcessingErr, ActorRef, RpcReplyPort};

pub enum PolluxEvaluationMessage {
...
impl Actor for PolluxEvaluatorActor {
    type Msg = PolluxEvaluationMessage;
    ...
    async fn handle(
        ...
        match message {
            PolluxEvaluationMessage::EvaluatePackage(cargo_package) => {
            ...
            PolluxEvaluationMessage::AggregateResults(reply) => {
